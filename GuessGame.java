    ...
    public void startGame(){
        ...
        while(true) {
            ...
            if (p1isRight || p2isRight || p3isRight) {
                System.out.println("Hot Dog! We have a wiener");
                ...
                System.out.println("Game is ovah");
                break;

            } else {
                System.out.println("It's a simple guessing game and you failed. Deep introspection required");
            }
        }
    }
}